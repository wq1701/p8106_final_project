...
glmn.fit <- train(class~., data, 
                    ...
                    metric = "ROC",
                    trControl = ctrl)
glmn_plotylab = plot(glmn.fit, xTrans = function(x) log(x), 
                 highlight = T,
                 main = 'Regularized logistic regression Cross-Valiation',
...
nb_plot = plot(nb.fit, 
                 highlight = T,
                 main = 'Naive Bayes Cross-Valiation',
...
knn_plot = ggplot(knn.fit, highlight = T) + 
  labs(title="KNN Cross-Valiation", y = "ROC")
...
cart_plot = ggplot(rpart.fit, highlight = TRUE) + 
  labs(title="CART Cross-Valiation", x = "cp", y = "ROC")
...
cit_plot = ggplot(ctree.fit, highlight = TRUE) + 
  labs(title="CIT Cross-Valiation", x = "min criterion", y = "ROC")
...
rf_plot = ggplot(rf.fit, highlight = TRUE) + 
  labs(title="Random Forests Cross-Valiation", x = "mtry", y = "ROC")
...
gbmB_plot = ggplot(gbmB.fit, highlight = TRUE) + 
  labs(title="Binomial Loss Boosting Cross-Valiation", 
      y = "ROC")
...
gbmA_plot = ggplot(gbmA.fit, highlight = TRUE) + 
  labs(title="AdaBoost Cross-Valiation", y = "ROC")
...
svml_plot = ggplot(svml.fit, highlight = TRUE) + 
  labs(title="SVM with Linear Boundary Cross-Valiation", x = "cost", y = "ROC")
...
svmr_plot = ggplot(svmr.fit, highlight = TRUE)+ 
  labs(title="SVM with Radial Kernal Cross-Valiation", y = "ROC")
