...
Naive Bayes assumes features are independent in each class while the truth may not be like that. It's also useful when number of predictors is large, but in this case the number of predictors is not large.
