...
```{r echo=FALSE, out.width="100%", fig.cap="Distribution of Predictors"}
...
```{r echo= FALSE, out.width="100%", fig.cap="ROC Comparison"}
knitr::include_graphics("roc_comparison.png")
```
...
```{r echo= FALSE, out.width="100%", fig.cap="Cross-validation"}
knitr::include_graphics("cross_validation1.png")
```

```{r echo= FALSE, out.width="100%", fig.cap="Cross-validation"}
knitr::include_graphics("cross_validation2.png")
```